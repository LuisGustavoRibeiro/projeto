...
$(function () {
    ...
    $demoSettings.append(
        ...
        + '</label>'
        + '<p>Deixe a mini barra lateral expandir em pairar</p>'
        + '</div>'
        ...
        + 'Alternar a pele da barra lateral direita'
        + '</label>'
        + '<p>Alternar entre peles escuras e claras para a barra lateral direita</p>'
        + '</div>'
    )
    ...
    $demoSettings.append('<h4 class="control-sidebar-heading">Altenar cores do Layout</h4>')
