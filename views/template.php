...
<head>
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/bootstrap/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/bootstrap/bootstrap-daterangepicker/daterangepicker.css">
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?= BASE_URL; ?>/adminLTE/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?= BASE_URL; ?>/assets/adminLTE/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?= BASE_URL; ?>/assets/adminLTE/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Sales Department
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= $viewData['usuario_nome']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?= $viewData['usuario_nome']; ?> - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php foreach($viewData['menu_lista'] as $item) { ?>
        <li>
            <a href="<?= BASE_URL; ?>/<?= $item['link'] ?>">
              <i class="fa <?= $item['classe'] ?>"></i> <span><?= utf8_encode($item['nome']) ?></span>
              <span class="pull-right-container">
                <!-- <small class="label pull-right bg-warning">new</small> -->
              </span>
            </a>
        </li>
        <?php } ?>          
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2020 <a href="#">Projeto</a>.</strong> Direitos Reservados
    reserved.
  </footer>
...
<script src="<?= BASE_URL; ?>/assets/bootstrap/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?= BASE_URL; ?>/assets/bootstrap/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
